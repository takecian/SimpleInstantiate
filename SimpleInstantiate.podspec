...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of SimpleInstantiate."
  ...
  # Or just: s.author    = "takecian"
  # s.authors            = { "takecian" => "fujikidev@gmail.com" }
  # s.social_media_url   = "http://twitter.com/takecian"
